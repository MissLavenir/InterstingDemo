package com.example.interestingdemo.simple
 ...
 * @author Attect
 */
open class SimpleRecyclerViewAdapter<T>(private val owner: T) : RecyclerView.Adapter<SimpleRecyclerViewAdapter.BasicViewHolder<out UniqueData>>() {
